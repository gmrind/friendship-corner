class AddCachedVotesToComments < ActiveRecord::Migration
  def self.up
    ...
    add_column :comments, :cached_votes_score, :integer, :default => " "
    add_column :comments, :cached_votes_up, :integer, :default => " "
    add_column :comments, :cached_votes_down, :integer, :default => " "
    add_column :comments, :cached_weighted_score, :integer, :default => " "
